(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (which-key monokai-theme atom-dark-theme ## exec-path-from-shell enh-ruby-mode auto-complete use-package zenburn-theme powerline yaml-mode puppet-mode magit-gerrit magit))))
(custom-set-faces
