(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ansible ansible-doc ansible-vault json-mode rpm-spec-mode flycheck go-mode which-key monokai-theme ## exec-path-from-shell enh-ruby-mode auto-complete use-package powerline yaml-mode puppet-mode magit-gerrit magit)))
