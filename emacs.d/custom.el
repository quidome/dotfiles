(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flycheck-pycheckers magit exec-path-from-shell use-package gitignore-mode powerline ansible flycheck go-mode pyenv-mode pyenv rubocop magit-gerrit markdown-mode puppet-mode yaml-mode leuven-theme))))
(custom-set-faces
